...
public  class Demoshybrid extends Capability {
	...
	// id is want as called as resource-id, content-dec can be also called as what accessibility id
	@Test(enabled=false)
...
//  Click on visit website
  ...
  //i have been navigate to the browser and i want to work with the browser
